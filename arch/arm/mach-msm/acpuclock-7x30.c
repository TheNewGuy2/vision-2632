...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
        ...
        { 368640, PLL_3,    5, 1,  122800, 850, VDD_RAW(850) },
	...
	/* Make sure any freq based from PLL_2 is a multiple of 19200! */
        ...
        { 825600, PLL_2,    3, 0,  192000, 900, VDD_RAW(900) },
        { 844800, PLL_2,    3, 0,  192000, 925, VDD_RAW(925) },
        { 864000, PLL_2,    3, 0,  192000, 925, VDD_RAW(925) },
	...
	{ 1747200, PLL_2,   3, 0,  192000, 1375, VDD_RAW(1375) },
	{ 1804800, PLL_2,   3, 0,  192000, 1425, VDD_RAW(1425) },
//	{ 1843200, PLL_2,   3, 0,  192000, 1375, VDD_RAW(1375) },
//	{ 1900800, PLL_2,   3, 0,  192000, 1375, VDD_RAW(1375) },
//	{ 1958400, PLL_2,   3, 0,  192000, 1375, VDD_RAW(1375) },
...
static unsigned int acpuclk_get_current_vdd(void)
{
	...
	for (vdd_mv = 800; vdd_mv <= 1425; vdd_mv += 25)
